        ...
        <form onSubmit={handleSubmit} className="px-8 py-6">
          ...
          <div className="mt-6 space-y-2">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div
                className={`w-full h-60 sm:w-2/3 flex flex-col items-center justify-center rounded-lg border-2 border-dashed ${
                  imagePreview ? "border-gray-300" : "border-gray-300"
                } p-6 text-center hover:border-blue-400 transition-colors cursor-pointer`}
