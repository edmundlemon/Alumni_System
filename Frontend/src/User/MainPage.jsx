...
import { FaUsers, FaComments, FaCalendarDays } from "react-icons/fa6";
          ...
          <div key={idx} className="flex gap-4">
            {mokVioce.map((alumni) => (
              <div
                ...
                onClick={() => navigate("/alumniMainPage")}
                className="cursor-pointer w-[280px] h-[200px] bg-white shadow-lg border rounded-xl p-6 flex flex-col items-start text-start"
              >
    ...
    <section>
        ...
        <div className="absolute inset-0 flex flex-col justify-center items-center text-white">
          ...
          <div className="flex gap-2 mt-7">
            <button
              ...
              className="px-4 py-2 text-lg bg-[#65aaf0] text-white rounded-lg hover:bg-blue-700 transition"
            >
              Join The Network
            </button>
            <button className="px-4 py-2 border-2 text-lg  text-white rounded-lg hover:bg-gray-300 transition">
              Learn More
            </button>
          </div>
        </div>
      ...
      <div className="mt-16 w-full px-20">
        ...
        <div className="grid grid-cols-4 gap-4 mt-8 w-full">
          <div
            onClick={() => navigate("/alumniMainPage")}
            className="cursor-pointer hover:scale-105 hover:shadow-xl transition-transform duration-300 flex flex-col items-center justify-center bg-white shadow-md border rounded-lg p-8"
          >
          ...
          <div
            onClick={() => navigate("/eventMainPage")}
            className="cursor-pointer hover:scale-105 hover:shadow-xl transition-transform duration-300 flex flex-col items-center justify-center bg-white shadow-md border rounded-lg p-8"
          >
            ...
            <p>networking events, workshops</p>
            <p>and reunions</p>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-lg mb-8 leading-relaxed">
              Every gift, regardless of size, makes a difference and helps us continue the tradition of excellence at MMU.
            </p>
            <div className="flex gap-4">
              <button
                onClick={() => navigate("/donationMainPage")}
                className="px-6 py-3 bg-[#65aaf0] hover:bg-blue-600 text-white font-medium rounded-lg transition-all shadow-lg"
              >
                Donate Now
              </button>
